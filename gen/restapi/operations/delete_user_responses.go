...
/*DeleteUserOK Success DELETing user under given username
...
type DeleteUserInternalServerError struct {
	...
	/*
	  In: Body
	*/
	Payload *DeleteUserInternalServerErrorBody `json:"body,omitempty"`
}
...
func (o *DeleteUserInternalServerError) WithPayload(payload *DeleteUserInternalServerErrorBody) *DeleteUserInternalServerError {
	o.Payload = payload
	return o
}

// SetPayload sets the payload to the delete user internal server error response
func (o *DeleteUserInternalServerError) SetPayload(payload *DeleteUserInternalServerErrorBody) {
	o.Payload = payload
}
