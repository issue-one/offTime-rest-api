...
func (o *GetRoomsParams) bindLimit(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
	...
	if raw == "" { // empty values pass all other validations
		// Default values have been previously initialized by NewGetRoomsParams()
		return nil
	}
...
func (o *GetRoomsParams) validateLimit(formats strfmt.Registry) error {
...
func (o *GetRoomsParams) bindOffset(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
		raw = rawData[len(rawData)-1]
	}
...
func (o *GetRoomsParams) validateOffset(formats strfmt.Registry) error {
